...
class LoraLayer:
    ...
    def update_layer(self, adapter_name, r, lora_alpha, lora_dropout, init_lora_weights):
        ...
        if r > 0:
            ...
            self.lora_B.update(nn.ModuleDict({adapter_name: nn.Linear(r, self.in_features, bias=False)}))
...
class Linear(nn.Linear, LoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        LoraLayer.__init__(self, in_features=in_features, out_features=in_features)
...
class Embedding(nn.Embedding, LoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        LoraLayer.__init__(self, in_features=num_embeddings, out_features=num_embeddings)
    ...
    class Linear8bitLt(bnb.nn.Linear8bitLt, LoraLayer):
        ...
        def forward(self, x: torch.Tensor):
            ...
            if self.disable_adapters or self.active_adapter not in self.lora_A.keys():
                ...
                result = result.narrow(2, 0, 384) + output.narrow(2, 0, 384)
            return result
